...
import './CategoryAuditPage.css';
import './CategoryAuditPage-Mobile.css';
...
export function CategoryAuditPage() {
  ...
  if (isLoading) {
    return (
      <section className="category-audit-page">
        <div className="category-audit-page__loading">
  ...
  return (
    <section className="category-audit-page">
      <header className="category-audit-page__header">
        <div className="category-audit-page__header-left">
          <Button
            variant="ghost"
          ...
          <h1 className="category-audit-page__title">История изменений категории</h1>
        </div>
      </header>

      <div className="category-audit-page__content">
        <div className="category-audit-page__panel">
          {auditData.length === 0 ? (
            <div className="category-audit-page__empty">
            ...
            <>
              ...
              {totalPages > 1 && (
                <Pagination
                  ...
                  loading={isLoading}
                  className="category-audit-page__pagination"
                />
              )}
            </>
          )}
