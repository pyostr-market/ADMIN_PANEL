...
import styles from './CategoryAuditPage.module.css';
      ...
      <div className={styles.auditDetailModal}>
        <div className={styles.auditDetailModalHeader}>
          <div className={styles.auditDetailRow}>
            ...
            <span className={`${styles.auditDetailValue} audit-action-${auditRecord.action}`}>
              {auditRecord.action}
            </span>
          </div>
          <div className={styles.auditDetailRow}>
...
export function CategoryAuditPage() {
  ...
  }, [categoryId, currentPage, notifications, hasShownError]);
  ...
  if (isLoading) {
    return (
      <section className={styles.categoryAuditPage}>
        <div className={styles.categoryAuditPageLoading}>
  ...
  return (
    <section className={styles.categoryAuditPage}>
      <header className={styles.categoryAuditPageHeader}>
        <div className={styles.categoryAuditPageHeaderLeft}>
          <Button
            variant="ghost"
          ...
          <h1 className={styles.categoryAuditPageTitle}>История изменений категории</h1>
        </div>
      </header>

      <div className={styles.categoryAuditPageContent}>
        <div className={styles.categoryAuditPagePanel}>
          {auditData.length === 0 ? (
            <div className={styles.categoryAuditPageEmpty}>
            ...
            <>
                      ...
                      return (
                        <tr key={record.id} className={styles.auditTableRow}>
                          <td className={styles.auditTableCell}>
                            <span className={`${styles.auditActionBadge} audit-action-badge--${record.action}`}>
                              {record.action}
                            </span>
                          </td>
                          <td className={styles.auditTableCell}>
              ...
              {totalPages > 1 && (
                <Pagination
                  ...
                  loading={isLoading}
                  className={styles.categoryAuditPagePagination}
                />
              )}
            </>
          )}
