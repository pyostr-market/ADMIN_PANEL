...
import styles from './ManufacturerAuditPage.module.css';
...
export function ManufacturerAuditPage() {
  ...
  }, [manufacturerId, currentPage, notifications, hasShownError]);
  ...
  if (isLoading) {
    return (
      <section className={styles.manufacturerAuditPage}>
        <div className={styles.manufacturerAuditPageLoading}>
  ...
  return (
    <section className={styles.manufacturerAuditPage}>
      <header className={styles.manufacturerAuditPageHeader}>
        <div className={styles.manufacturerAuditPageHeaderLeft}>
          <Button
            variant="ghost"
            onClick={() => navigate(`/catalog/manufacturers/${manufacturerId}`)}
            className={styles.backButton}
          >
            ← Назад
          </Button>
          <h1 className={styles.manufacturerAuditPageTitle}>История изменений производителя</h1>
        </div>
      </header>

      <div className={styles.manufacturerAuditPageContent}>
        <div className={styles.manufacturerAuditPagePanel}>
          {auditData.length === 0 ? (
            <div className={styles.manufacturerAuditPageEmpty}>
            ...
            <>
              ...
              {totalPages > 1 && (
                <Pagination
                  ...
                  loading={isLoading}
                  className={styles.manufacturerAuditPagePagination}
                />
              )}
            </>
          )}
