...
export function ManufacturerAuditPage() {
  ...
  const loadAudit = useCallback(async () => {
    ...
    try {
      ...
      const { items, total: totalItems } = await getManufacturerAuditRequest({
  ...
  }, [manufacturerId, currentPage, notifications]);
  ...
  if (isLoading) {
    return (
      <section className="manufacturer-audit-page">
        <div className="manufacturer-audit-page__loading">
  ...
  return (
    <section className="manufacturer-audit-page">
      <header className="manufacturer-audit-page__header">
        <div className="manufacturer-audit-page__header-left">
          <Button
            variant="ghost"
          ...
          <h1 className="manufacturer-audit-page__title">История изменений производителя</h1>
        </div>
      </header>

      <div className="manufacturer-audit-page__content">
        <div className="manufacturer-audit-page__panel">
          {auditData.length === 0 ? (
            <div className="manufacturer-audit-page__empty">
            ...
            <>
              ...
              {totalPages > 1 && (
                <Pagination
                  ...
                  loading={isLoading}
                  className="manufacturer-audit-page__pagination"
                />
              )}
            </>
          )}
