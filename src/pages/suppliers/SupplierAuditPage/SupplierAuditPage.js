...
import styles from './SupplierAuditPage.module.css';
...
export function SupplierAuditPage() {
  ...
  if (isLoading) {
    return (
      <section className={styles.supplierAuditPage}>
        <div className={styles.supplierAuditPageLoading}>
  ...
  return (
    <section className={styles.supplierAuditPage}>
      <header className={styles.supplierAuditPageHeader}>
        <div className={styles.supplierAuditPageHeaderLeft}>
          <Button
            variant="ghost"
          ...
          <h1 className={styles.supplierAuditPageTitle}>История изменений поставщика</h1>
        </div>
      </header>

      <div className={styles.supplierAuditPageContent}>
        <div className={styles.supplierAuditPagePanel}>
          {auditData.length === 0 ? (
            <div className={styles.supplierAuditPageEmpty}>
            ...
            <>
              ...
              {totalPages > 1 && (
                <Pagination
                  ...
                  loading={isLoading}
                  className={styles.supplierAuditPagePagination}
                />
              )}
            </>
          )}
