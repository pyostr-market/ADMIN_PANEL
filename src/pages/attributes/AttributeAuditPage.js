...
export function AttributeAuditPage() {
  ...
  if (isLoading) {
    return (
      <section className="attribute-audit-page">
        <div className="attribute-audit-page__loading">
  ...
  return (
    <section className="attribute-audit-page">
      <header className="attribute-audit-page__header">
        <div className="attribute-audit-page__header-left">
          <Button
            variant="ghost"
          ...
          <h1 className="attribute-audit-page__title">История изменений атрибута</h1>
        </div>
      </header>

      <div className="attribute-audit-page__content">
        <div className="attribute-audit-page__panel">
          {auditData.length === 0 ? (
            <div className="attribute-audit-page__empty">
            ...
            <>
              ...
              {totalPages > 1 && (
                <Pagination
                  ...
                  loading={isLoading}
                  className="attribute-audit-page__pagination"
                />
              )}
            </>
          )}
